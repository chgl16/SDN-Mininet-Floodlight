...
public class TopologyInstance {
    ...
    private static Map<NodePortTuple, Set<Link>>   links; /* every link in entire topology */
    ...
    public static void printTopology() {
        ...
        */
        ...
        File file2 = new File("./output/sw-sw.txt");
        if(file1.exists()) {
        ...
        try {
        	...
        	fileWriter.write("@ Switch <-> Switch\r\n");
        	for(NodePortTuple key : links.keySet()) {
        		System.out.println("Key = " + key);
        	}
        	
        	Set<String> set = new HashSet<String>();
        	for(Set<Link> value : links.values()) {
